...
The `foundry` maintainers take all security issues in the project
seriously. Thank you for improving the security of `foundry`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`foundry` leverages GitHub's private vulnerability reporting.
...
reach out via email at [patrice.nivaggioli@gmail.com](mailto:patrice.nivaggioli@gmail.com).
